    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="#health-disclaimer" class="p-4 border border-ayur-sage rounded-lg hover:bg-ayur-cream transition duration-300 group">
                    <div class="flex items-center">
                        ...
                        <span class="text-ayur-brown group-hover:text-ayur-green transition duration-300">Health Disclaimer</span>
                    </div>
                </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div id="health-disclaimer" class="bg-white rounded-2xl shadow-lg p-8 section-anchor">
                <div class="flex items-center mb-6">
                    <div class="bg-ayur-green text-white rounded-full w-12 h-12 flex items-center justify-center text-lg font-bold mr-4">3</div>
                    <h2 class="font-playfair text-2xl font-bold text-ayur-green">Health Disclaimer</h2>
                </div>
                <div class="space-y-6">
                    <div class="bg-yellow-50 border border-yellow-300 rounded-lg p-6">
                        <h3 class="font-semibold text-yellow-800 text-lg mb-3">Medical Advice</h3>
                        <p class="text-gray-700 leading-relaxed mb-4">The information on this website, including all product descriptions, articles, and recommendations, is for informational purposes only. It is not intended to be a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition.</p>
                        <ul class="text-yellow-800 space-y-2 text-sm mt-4">
                            ...
                            <li class="flex items-start"><span class="w-2 h-2 bg-yellow-600 rounded-full mr-3 mt-2"></span>Individual results from using our products may vary and are not guaranteed.</li>
                            <li class="flex items-start"><span class="w-2 h-2 bg-yellow-600 rounded-full mr-3 mt-2"></span>Discontinue use and consult a healthcare professional if you experience any adverse reactions.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-8 mt-8">
            <div id="orders-payments" class="bg-white rounded-2xl shadow-lg p-8 section-anchor">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-4">
                                <div class="flex items-start space-x-4 p-3 bg-ayur-cream rounded-lg border border-ayur-sage">
            ...
            <div id="limitation-liability" class="bg-white rounded-2xl shadow-lg p-8 section-anchor">
                ...
                <div class="space-y-6">
                    <div class="bg-yellow-50 border border-yellow-300 rounded-lg p-6">
                        <h3 class="font-semibold text-yellow-800 text-lg mb-3">Service Disclaimers</h3>
            ...
            <div id="changes-terms" class="bg-white rounded-2xl shadow-lg p-8 section-anchor">
                <div class="flex items-center mb-6">
                    <div class="bg-ayur-green text-white rounded-full w-12 h-12 flex items-center justify-center text-lg font-bold mr-4">13</div>
            ...
            </div> </div> </div> @include('includes.footer')