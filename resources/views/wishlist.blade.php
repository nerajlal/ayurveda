@include('includes.header')
    ...
    <!-- Wishlist Items -->
    <div class="container mx-auto px-4 pb-16 @if (!session('success') && !session('error')) mt-8 @endif">
        @if ($wishlistItems->isNotEmpty())
            <div id="products-container" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                {{-- The script below will populate this --}}
            </div>
    ...
    <script>
        const products = @json($wishlistItems->map(function ($item) {
            ...
            return [
                ...
                'name' => $product->name,
                'slug' => $product->slug,
                'category' => match($product->category_name) {
                    'Herbal Oils' => 'oils',
                    'Skincare' => 'skincare',
                    'Herbal Tea' => 'teas',
        ...
        function setupEventListeners() {
            // No filters on this page, but keeping the function for now
        }

        function sortProducts(sortType) {
            // Sorting logic can be kept if needed
            renderProducts();
        }
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover-lift product-card" data-product-id="${product.id}">
                    <div class="relative">
                        ...
                        <div class="absolute top-4 right-4">
                            <button class="remove-wishlist-btn w-8 h-8 bg-white bg-opacity-80 rounded-full flex items-center justify-center hover:bg-red-500 hover:text-white transition duration-300" title="Remove from Wishlist">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <div class="mt-4 flex justify-between items-center">
                            ...
                            <a href="/product/${product.slug}" class="text-ayur-green hover:text-ayur-gold transition duration-300">View Product</a>
                        </div>
                    </div>
                </div>
            `;
        ...
        function renderPagination() {
            // Pagination logic can be kept if needed
        }
    </script>
                category: "oils",
                price: 899,
