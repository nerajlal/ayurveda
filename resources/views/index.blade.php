            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                @forelse ($latestProducts as $product)
                    <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover-lift">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-ayur-brown text-sm mb-4">{{ $product->subtitle }}</p>
                            <div class="flex justify-between items-center">
                                <span class="font-bold text-ayur-green text-lg">₹{{ number_format($product->sizes->first()->price ?? 0, 2) }}</span>
                                <a href="{{ route('products.show', $product->id) }}">
                ...
                @empty
                    <div class="col-span-4 text-center">
                        <p class="text-ayur-brown">No products found.</p>
                    </div>
                @endforelse
            </div>
